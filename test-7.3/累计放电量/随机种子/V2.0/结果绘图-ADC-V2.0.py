...
out_dir = r"D:\任务归档\电池\研究\小论文1号\DOCUMENT\fig\Results\ADC_estimation_2.0"
...
def save_one_small_fig(title, savename, x, real, est, color,
    ...
    # --- 主图绘制 ---
    ax1.plot(x, real, ls='none', marker='o', ms=2, color=c_real, label='Real ADC', alpha=0.8)
    ax1.plot(x, est, ls='none', marker='D', ms=2, color=color, label='Estimated ADC', alpha=0.8)

    ax1.set_xlabel("Cycle", fontsize=10)
    ax1.set_ylabel("ADC (Ah)", fontsize=10)
