...
class Config:
    def __init__(self):
        # --- 数据和路径设置 (修改为三个输入路径) ---
        self.path_A_sequence = r'/home/scuee_user06/myh/电池/data/selected_feature/relaxation/Interval-Downsampling_1200x'  # A文件: 弛豫段电压序列 (1200点/循环)
...
if __name__ == '__main__':
    ...
    base_save_path = '/home/scuee_user06/myh/电池/data/cyclenet_gridsearch-1200x_results'  # 设置一个基础保存路径
