...
class Config:
    def __init__(self):
        # --- 数据和路径设置 (修改为三个输入路径) ---
        self.path_A_sequence = r'/home/scuee_user06/myh/电池/data/selected_feature/relaxation/Interval-Downsampling_200x'  # A文件: 弛豫段电压序列 (1200点/循环)
        ...
        # --- 模型超参数 (已修改) ---
        self.sequence_length = 6  # A文件的序列长度 (弛豫段电压的点数)
...
if __name__ == '__main__':
    ...
    base_save_path = '/home/scuee_user06/myh/电池/data/cyclenet_gridsearch-200x_results'  # 设置一个基础保存路径
